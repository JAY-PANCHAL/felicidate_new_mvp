                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(AppPngIcons.talkSomeoneBack),
                            fit: BoxFit.cover)),
                    child: Padding(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: 'Note:',
                                  style:
                                      Styles.textFontMedium(size: 14).copyWith(
                                ...
                                TextSpan(
                                  text:
                                      ' that your felifriend are not expert and will\nonly listen to your problems',
                                  style:
                                      Styles.textFontRegular(size: 14).copyWith(
                                    fontStyle: FontStyle.italic,
                                  ),
                                ),
                              ],
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          width: 1, color: Color(0xFFFFD9E2)),
